...
export const SampleExperimentM = () => {
  const PersianSampleExperimentM = () => <>
    <PersianH2>
      طراحی و پیاده سازی فرآیند آزمایش نمونه متالورژی جهاد دانشگاهی شریف
    </PersianH2>
    <PersianParagraph>
      ین فرآیند به عنوان یک راه برای پیگیری نمونه‌هایی که به آنها ارسال
      می‌شوند و به عنوان یک روش برای سازماندهی جریان کار دپارتمان و چاپ نتایج
      آزمایش‌ها تعریف شد.
    </PersianParagraph>
    <PersianParagraph>
  ...
  const EnglishSampleExperimentM = () => <>
    <h2>
      Design and Implementation of Sample Experimenting Process for Metallurgy
  ...
  return <LanguageElement PersianElement={PersianSampleExperimentM} EnglishElement={EnglishSampleExperimentM} />;
};
