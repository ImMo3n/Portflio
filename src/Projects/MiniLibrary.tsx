...
export const MiniLibrary = () => {
  ...
  const PersianMiniLibrary = () => <>
    ...
    <PersianParagraph>
      ...
      <PersianParagraph>
        Gridها در Processmaker ساختارهایی مشابه جدول هستند که دارای مجموعه‌ای از
        عناصر ورودی درون خود هستند. بنابراین، اگر می‌خواهید مثلاً کاربران خود را
        به صورت فرمی برای 5 نفر پر کنند، به جای ارسال 5 فرم، تنها یک فرم با
        گریدی از 5 ردیف اطلاعات ارسال می‌کنید. این به کاربر اجازه می‌دهد اطلاعات
        مربوط به 5 نفر را در یک فرم گردآوری کند و با ارسال یک فرم تنها، اطلاعات
        را به راحتی ارسال کند.
      </PersianParagraph>
      <PersianParagraph>
