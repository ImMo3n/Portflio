...
export const ReactSkill = () => {
  ...
  return <LanguageElement PersianElement={PersianReactSkill} EnglishElement={EnglishReactSkill}/>

  // const language = useLanguage();
  // console.log(language);

  // let ReactSkillElement = () => <></>
